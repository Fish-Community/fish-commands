            ...
            return __awaiter(this, arguments, void 0, function (_b) {
                ...
                return __generator(this, function (_h) {
                    switch (_h.label) {
                        ...
                        case 9:
                            _h.sent();
                            outputSuccess(f(templateObject_4 || (templateObject_4 = __makeTemplateObject(["", " has been muted for ", "", "."], ["", " has been muted for ", "", "."])), args.player, (0, utils_1.formatTime)(time), message ? " with reason: [white]".concat(message, "[]") : ""));
    ...
    crash: {
        ...
        handler: function (_a) {
            ...
            if ((0, utils_1.crashClient)(target.player)) {
                outputSuccess(f(templateObject_75 || (templateObject_75 = __makeTemplateObject(["Crashed client of ", "."], ["Crashed client of ", "."])), target));
            }
            else {
                output(f(templateObject_76 || (templateObject_76 = __makeTemplateObject(["Attempted to crash client of ", ". The crash will only occur once the sync completes."], ["Attempted to crash client of ", ". The crash will only occur once the sync completes."])), target));
            }
        }
    },
    yeet: {
            ...
            return __awaiter(this, void 0, void 0, function () {
                ...
                return __generator(this, function (_c) {
                    switch (_c.label) {
                        ...
                        case 1:
                            _c.sent();
                            outputSuccess(f(templateObject_77 || (templateObject_77 = __makeTemplateObject(["Sent ", " to a parallel universe."], ["Sent ", " to a parallel universe."])), target));
                            return [2 /*return*/];
                    }
                });
            });
                ...
                return __generator(this, function (_c) {
                    switch (_c.label) {
                        ...
                        case 3:
                            ...
                            return [3 /*break*/, 1];
                        case 4:
                            outputSuccess(f(templateObject_78 || (templateObject_78 = __makeTemplateObject(["Spammed ", " with menus."], ["Spammed ", " with menus."])), target));
                            return [2 /*return*/];
                    }
                });
            });
