...
exports.commands = (0, commands_1.commandList)({
    ...
    clearunit: {
        ...
        handler: function (_a) {
            ...
            if (target.blockedFromUnitsUntil == 0)
    ...
    info: {
        ...
        handler: function (_a) {
            ...
            if (sender.hasPerm("viewUUIDs"))
                output(f(templateObject_52 || (templateObject_52 = __makeTemplateObject(["\t[#FFAAAA]UUID: ", ""], ["\\t[#FFAAAA]UUID: ", ""])), args.target.uuid));
            if (sender.hasPerm("viewIPs"))
                output(f(templateObject_53 || (templateObject_53 = __makeTemplateObject(["\t[#FFAAAA]IP: ", ""], ["\\t[#FFAAAA]IP: ", ""])), args.target.ip()));
        }
    },
    spawn: {
    ...
    setblockr: {
        ...
        tapped: function (_a) {
            ...
            if (args.rotation != null && (args.rotation < 0 || args.rotation > 3))
                (0, commands_1.fail)(f(templateObject_58 || (templateObject_58 = __makeTemplateObject(["Invalid rotation ", ""], ["Invalid rotation ", ""])), args.rotation));
            if (tile == null)
