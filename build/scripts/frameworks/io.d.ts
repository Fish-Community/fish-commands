...
export declare function serialize<T extends Serializable>(settingsKey: string, schema: () => Schema<T>, oldSchema?: () => Schema<T>, fixer?: (raw: T) => T, saveEvent?: keyof (typeof FishEvents)["listeners"]): <This extends Record<Name, T | null>, Name extends string | symbol>(_: unknown, { addInitializer, access, name }: ClassFieldDecoratorContext<This, T | null> & {
    name: Name;
    static: true;
}) => void;
