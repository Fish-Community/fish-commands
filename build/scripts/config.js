...
var FishServer = /** @class */ (function () {
    ...
    FishServer.all = [];
    FishServer.attack = new FishServer("attack", "51.81.48.124", "6567", ["attac", "atack", "atak", "atck", "atk", "a"]);
    FishServer.survival = new FishServer("survival", "51.81.48.124", "6570", ["surviv", "surv", "sur", "su", "s", "sl"]);
    FishServer.pvp = new FishServer("pvp", "51.81.48.124", "6569", ["pv", "p", "v", "playerversusplayer"]);
    FishServer.sandbox = new FishServer("sandbox", "51.81.48.124", "6568", ["sand", "box", "sa", "sb"]);
    FishServer.hexed = new FishServer("hexed", "51.81.48.124", "6572", ["h", "hx", "hxd", "hpvp", "hxpvp", "hexpvp"]);
    FishServer.minigame = new FishServer("minigame", "51.81.48.124", "6571", ["m", "mg", "mini", "minig", "mgame", "mng", "minigame", "mpvp"]);
    FishServer.testing = new FishServer("testing", "51.81.48.124", "6573", ["test", "testsrv", "t", "testingserver", "testserver"], undefined, "active");
