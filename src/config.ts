...
export const tips = {
	...
	normal: [
		...
		`run /aoelog false 15 killed to check up to 15 tiles that contains unit deaths in an area `,
		`Aoelog's area is limited by an 100x100 area, please dont fry our servers`,
		`Aoelog can log tiles in an area by you just clicking on the 2 corners of the rectangular area`,
		`Aoelog takes 3 arguements, namely persist: true/false/1/0, amount:number, action:just run /aoelog true 1 null`,
		`Aoelog also accepts non-intergers values, but most of them get defaulted to 10 `,
		`Aoelog is the plural version of Tilelog, access it via /aoelog`,
